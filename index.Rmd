...
papersize: A4
lof: yes
description: "Veiledning i installasjon og bruk av VeraCrypt for sikker lagring og sletting av data ved Senter for klinisk dokumentajson og evaluering (SKDE), Helse Nord RHF."
cover-image: images/logo.svg
---

# Forord {-}

```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), fig.link='https://helse-nord.no/skde', fig.alt='logo'}
